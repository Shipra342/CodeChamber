...
<%! 
	...
	int i;
%>
<div style="text-align:center;font-size:30px;font-weight:900">Active Colleges</div>
<br>
<br>

<table style="width:60%;position:absolute;left:20%">
<tr>
	<th>Sr. No.</th><th>College Name</th><th>ID</th><th>Pool</th><th>Active</th>
</tr>
  <%
	try{
		st=Connections.makeConnection();
		rs=st.executeQuery("select * from activeSessions order by pool");
		i=1;
		while(rs.next())
		{
			%>	
